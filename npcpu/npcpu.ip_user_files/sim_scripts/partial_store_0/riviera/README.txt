...
#
# Generated by export_simulation on Wed May 04 17:22:57 CST 2022
#
################################################################################
...
'-reset_run' switch to the './partial_store_0.sh' script.

./partial_store_0.sh -reset_run
...
./partial_store_0.sh -noclean_files

For more information on the script, please type './partial_store_0.sh -help'.
