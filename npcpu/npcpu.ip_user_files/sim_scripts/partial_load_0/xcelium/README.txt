...
#
# Generated by export_simulation on Wed May 04 17:22:34 CST 2022
#
################################################################################
...
'-reset_run' switch to the './partial_load_0.sh' script.

./partial_load_0.sh -reset_run
...
./partial_load_0.sh -noclean_files

For more information on the script, please type './partial_load_0.sh -help'.
