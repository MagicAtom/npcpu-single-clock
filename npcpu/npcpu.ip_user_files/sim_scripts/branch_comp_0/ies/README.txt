...
#
# Generated by export_simulation on Tue May 03 22:19:44 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './branch_comp_0.sh' script.

./branch_comp_0.sh -reset_run
...
./branch_comp_0.sh -noclean_files

For more information on the script, please type './branch_comp_0.sh -help'.
