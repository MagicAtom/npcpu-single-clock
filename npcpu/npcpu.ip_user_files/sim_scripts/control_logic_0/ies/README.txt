...
#
# Generated by export_simulation on Tue May 10 22:41:18 CST 2022
#
################################################################################
...
'-reset_run' switch to the './control_logic_0.sh' script.

./control_logic_0.sh -reset_run
...
./control_logic_0.sh -noclean_files

For more information on the script, please type './control_logic_0.sh -help'.
