...
HD_PWD='/home/hulu/Documents/CPU/npcpu/npcpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NPCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NPCPU.tcl
